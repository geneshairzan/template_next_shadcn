...
export default function Home() {
  return (
    <UI.Col className="flex flex-col gap-2">
      ...
      <div className="flex-row gap-2 flex">
        <UI.IconButton name="home" color="rgb(255,0,0)" />
        <UI.IconButton name="home" variant="contained" />
        <UI.IconButton name="home" variant="outlined" />
      </div>
      <div>
